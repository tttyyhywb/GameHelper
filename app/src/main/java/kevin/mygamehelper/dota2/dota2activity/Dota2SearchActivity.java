...
import kevin.mygamehelper.dota2.adapter.UserIdListAdapter;
import kevin.lib.dota2.jsonResponse.Dota2Url;
import kevin.lib.dota2.jsonResponse.Dota2User;
import kevin.lib.base.gameBase.json.Response;
...
public class Dota2SearchActivity extends Activity {
    ...
    BaseRequest userListRequest = new BaseRequest() {
        ...
        protected void afterSuccess(String responseResult) {
            ...
            Response<Dota2User> response = new Response(dota2User);
            response = gson.fromJson(responseResult, new TypeToken<Response<Dota2User>>() {
            }.getType());
